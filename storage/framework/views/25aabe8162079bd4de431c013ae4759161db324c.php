                    ...
                    <div class="col-lg-2 col-md-6 mb-4">
                        <div class="footer-section">
                            ...
                            <ul class="footer-links">
                                <li><a href="<?php echo e(route('products.index')); ?>">Trang chủ</a></li>
                                <li><a href="<?php echo e(route('products.index', ['category' => 'computer'])); ?>">Máy tính</a></li>
                                <li><a href="<?php echo e(route('products.index', ['category' => 'phone'])); ?>">Điện thoại</a></li>
                                <li><a href="<?php echo e(route('products.index', ['category' => 'tv'])); ?>">Tivi</a></li>
                                <li><a href="<?php echo e(route('products.index', ['category' => 'air_conditioner'])); ?>">Máy lạnh</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <p class="copyright">
                            © <?php echo e(date('Y')); ?> ChoiXanh. Tất cả quyền được bảo lưu.
                        </p>
                    </div>
                    <div class="col-md-6">
...
</html><?php /**PATH C:\Users\tuan0\Downloads\DOANTHUCTAP\resources\views/footer.blade.php ENDPATH**/ ?>