...
<?php $__env->startSection('title', 'Debug Đặt Hàng'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                <li><strong>Driver:</strong> <?php echo e(config('mail.default')); ?></li>
                                <li><strong>From Address:</strong> <?php echo e(config('mail.from.address')); ?></li>
                                <li><strong>From Name:</strong> <?php echo e(config('mail.from.name')); ?></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h6>🌐 API Endpoint:</h6>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tuan0\Downloads\DOANTHUCTAP\resources\views/payment/debug.blade.php ENDPATH**/ ?>