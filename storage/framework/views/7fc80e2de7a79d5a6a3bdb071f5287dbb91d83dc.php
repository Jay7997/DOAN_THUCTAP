<?php $__env->startSection('title', 'Công ty Chồi Xanh Media - Chuyên cung cấp máy tinh và thiết bị công nghệ '); ?>
...
<div class="container">
    ...
    <div class="hero-section">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="<?php echo e(route('filters.index')); ?>" class="btn btn-outline-primary">Bộ lọc nâng cao</a> -->
            </div>
        </div>
    </div>
    ...
    <div class="category-pills mb-4">
        <div class="d-flex flex-wrap gap-2 justify-content-center">
            <a href="<?php echo e(route('products.index')); ?>" class="category-pill <?php echo e(!request('category') ? 'active' : ''); ?>">
                <i class="bi bi-grid-3x3-gap"></i> Tất cả
            </a>
            <a href="<?php echo e(route('products.index', ['category' => 'computer'])); ?>"
                class="category-pill <?php echo e(request('category') == 'computer' ? 'active' : ''); ?>">
                <i class="bi bi-pc-display"></i> Máy tính
            </a>
            <a href="<?php echo e(route('products.index', ['category' => 'phone'])); ?>"
                class="category-pill <?php echo e(request('category') == 'phone' ? 'active' : ''); ?>">
                <i class="bi bi-phone-fill"></i> Điện thoại
            </a>
            <a href="<?php echo e(route('products.index', ['category' => 'tv'])); ?>"
                class="category-pill <?php echo e(request('category') == 'tv' ? 'active' : ''); ?>">
                <i class="bi bi-display"></i> Tivi
            </a>
            <a href="<?php echo e(route('products.index', ['category' => 'air_conditioner'])); ?>"
                class="category-pill <?php echo e(request('category') == 'air_conditioner' ? 'active' : ''); ?>">
    ...
    <div class="search-results-info mb-4">
        <div class="alert alert-info">
            ...
            Kết quả tìm kiếm cho: "<strong><?php echo e(request('query')); ?></strong>"
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-sm btn-outline-primary ms-3">
    ...
    <section id="products" class="products-section">
        <?php if(isset($data['products']) && is_array($data['products']) && count($data['products']) > 0): ?>
        <div class="products-header mb-4">
            <h2 class="section-title">
                <?php if(request('category')): ?>
                <?php switch(request('category')):
                case ('computer'): ?>
                <i class="bi bi-pc-display"></i> Máy tính
                <?php break; ?>
                <?php case ('phone'): ?>
            ...
            <p class="section-subtitle">
                Tìm thấy <?php echo e(count($data['products'])); ?> sản phẩm
            </p>
        </div>
        ...
        <div class="product-grid">
            ...
            <div class="product-card fade-in-up" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="product-image-container">
                    <img src="<?php echo e($product['hinhdaidien'] ?? asset('images/default-product.jpg')); ?>"
                        alt="<?php echo e($product['tieude'] ?? 'Sản phẩm'); ?>"
                        class="product-image lazyload"
                        loading="lazy">
                    <div class="product-overlay">
                        <button class="btn-quick-view"
                            data-product-id="<?php echo e($product['id'] ?? $loop->index); ?>"
                            data-product-title="<?php echo e($product['tieude'] ?? 'Sản phẩm'); ?>">
                            <i class="bi bi-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="product-info">
                    <h3 class="product-title">
                        <a href="<?php echo e(route('products.show', ['id' => $product['id'] ?? $loop->index])); ?>"
                            class="product-link">
                            <?php echo e($product['tieude'] ?? 'Tên sản phẩm'); ?>
                    ...
                    <div class="product-meta">
                        ...
                        <span class="product-category">
                            <i class="bi bi-tag"></i> <?php echo e($product['category']); ?>
                    ...
                    <div class="product-price">
                        <?php if(isset($product['gia']) && $product['gia'] > 0): ?>
                        <span class="current-price"><?php echo e(number_format($product['gia'])); ?> ₫</span>
                        <?php if(isset($product['giacu']) && $product['giacu'] > $product['gia']): ?>
                        <span class="old-price"><?php echo e(number_format($product['giacu'])); ?> ₫</span>
                        <?php endif; ?>
                        <?php else: ?>
        ...
        <!-- Pagination -->
        <?php if(isset($data['products']) && count($data['products']) > 12): ?>
        ...
        <div class="no-products">
            <div class="no-products-content text-center">
                ...
                <div class="no-products-actions">
                    ...
                    <a href="<?php echo e(route('filters.index')); ?>" class="btn btn-outline-primary">
...
<section class="news-section mt-5">
    <div class="container">
        ...
        <div class="row">
            <?php $__currentLoopData = $news->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="news-card card h-100 shadow-sm">
                    <div class="news-image-container" style="height: 200px; overflow: hidden;">
                        <img src="<?php echo e($newsItem['hinhdaidien'] ?? 'https://via.placeholder.com/300x200?text=No+Image'); ?>"
                            alt="Ảnh tin tức"
                            class="card-img-top"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="mt-2">
                                <a href="<?php echo e(route('news.show', (string)$newsItem['id'])); ?>" class="btn btn-outline-primary btn-sm">
                                    Đọc thêm
                                </a>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tuan0\Downloads\DOANTHUCTAP\resources\views/products/index.blade.php ENDPATH**/ ?>