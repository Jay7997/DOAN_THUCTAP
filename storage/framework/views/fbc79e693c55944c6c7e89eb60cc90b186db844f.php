...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ChoiXanh - Cửa hàng điện tử'); ?></title>
                ...
                <div class="nav-wrapper">
                    ...
                    <div class="user-actions">
                        ...
                        <a href="/cart" class="action-btn cart-btn" title="Giỏ hàng">
                            ...
                            <span class="badge"><?php echo e(session('cart') ? count(session('cart')) : 0); ?></span>
                        </a>
                        ...
                        <div class="user-menu dropdown">
                            <button class="user-btn dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span><?php echo e(session('user_name') ?? session('user_email')); ?></span>
                                <i class="bi bi-chevron-down"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="<?php echo e(route('cart.history')); ?>">
                        ...
                        <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin-left: 10px;">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="auth-buttons">
                            <a href="<?php echo e(route('login.form')); ?>" class="btn btn-outline-primary">Đăng nhập</a>
                            <a href="<?php echo e(route('register.form')); ?>" class="btn btn-primary">Đăng ký</a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="category-nav">
            <div class="container">
                <ul class="category-list">
                    <li><a href="<?php echo e(route('products.index')); ?>" class="category-link">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu category-dropdown">
                            <li><a class="dropdown-item" href="<?php echo e(route('products.index', ['category' => 'computer'])); ?>">
                                    <i class="bi bi-pc-display"></i> Máy tính
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('products.index', ['category' => 'phone'])); ?>">
                                    <i class="bi bi-phone-fill"></i> Điện thoại
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('products.index', ['category' => 'tv'])); ?>">
                                    <i class="bi bi-display"></i> Tivi
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('products.index', ['category' => 'air_conditioner'])); ?>">
                                    <i class="bi bi-fan"></i> Máy lạnh
                                </a></li>
                        </ul>
                    </li>
                    <li><a href="<?php echo e(route('news.index')); ?>" class="category-link">
                            <i class="bi bi-file-text"></i> Tin tức
                        </a></li>
                    <li><a href="<?php echo e(route('lien-he')); ?>" class="category-link">
                            <i class="bi bi-envelope-fill"></i> Liên hệ
                        </a></li>
                    <li><a href="<?php echo e(route('filters.index')); ?>" class="category-link">
    ...
    <script>
        $(document).ready(function() {
            ...
            searchInput.on('input', function() {
                ...
                if (query.length >= 2) {
                    $.ajax({
                        url: '<?php echo e(route("products.suggestions")); ?>',
                        method: 'GET',
                        data: {
                            query: query
                        },
...
</html><?php /**PATH C:\Users\tuan0\Downloads\DOANTHUCTAP\resources\views/layouts/app.blade.php ENDPATH**/ ?>