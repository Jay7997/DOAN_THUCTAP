...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="thank-you">
                <h2>Xin chào <?php echo e($orderData['full_name']); ?>!</h2>
            ...
            <div class="order-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($orderData['full_name']); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Email:</span>
                    <span class="info-value"><?php echo e($orderData['email']); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Số điện thoại:</span>
                    <span class="info-value"><?php echo e($orderData['sdt']); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Địa chỉ:</span>
                    <span class="info-value"><?php echo e($orderData['address']); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Phương thức thanh toán:</span>
                    <span class="info-value">
                        <?php switch($orderData['payment_method']):
                        case ('cod'): ?>
                        ...
                        <?php break; ?>
                        <?php default: ?>
                        <?php echo e($orderData['payment_method']); ?>
            ...
            <div class="products-section">
                ...
                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="product-item">
                    ...
                    <div class="product-details">
                        ...
                        Thành tiền: <?php echo e(number_format($item['gia'] * $item['quantity'], 0, ',', '.')); ?>đ
                    </div>
                </div>
        ...
        <div class="footer">
            <p>© <?php echo e(date('Y')); ?> Điện Máy AtoZ. Tất cả quyền được bảo lưu.</p>
...
<?php /**PATH C:\Users\tuan0\Downloads\DOANTHUCTAP\resources\views/emails/order-confirmation.blade.php ENDPATH**/ ?>